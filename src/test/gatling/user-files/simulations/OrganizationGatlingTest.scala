...
class OrganizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organization entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "externalId":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "street":"SAMPLE_TEXT", "zipCode":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "type":null, "active":null}""")).asJSON
            .check(status.is(201))
