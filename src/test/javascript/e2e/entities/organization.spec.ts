...
describe('Organization e2e test', () => {
    ...
    it('should load Organizations', () => {
        ...
        expect(organizationComponentsPage.getTitle())
            .toMatch(/jobroomApp.organization.home.title/);
    ...
    it('should load create Organization dialog', () => {
        ...
        expect(organizationDialogPage.getModalTitle())
            .toMatch(/jobroomApp.organization.home.createOrEditLabel/);
    ...
    it('should create and save Organizations', () => {
        ...
        organizationDialogPage.getActiveInput().isSelected().then((selected) => {
            if (selected) {
