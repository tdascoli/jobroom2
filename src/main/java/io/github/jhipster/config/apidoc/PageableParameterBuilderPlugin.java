...
public class PageableParameterBuilderPlugin implements ParameterBuilderPlugin {
    ...
    public void apply(ParameterContext context) {
        ...
        if (type != null && Pageable.class.isAssignableFrom(type)) {
            Function<ResolvedType, ? extends springfox.documentation.schema.ModelReference> factory =
                createModelRefFactory(context);

            springfox.documentation.schema.ModelReference intModel = factory.apply(resolver.resolve(Integer.TYPE));
